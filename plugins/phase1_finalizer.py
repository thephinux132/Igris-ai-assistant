...
"""
Phase 1 Finalizer Plugin for Igris OS (Direct Plugin Execution)
...
def run():
    ...
    try:
        ...
        return "[ERROR] Could not import App class from GUI."
    ...
    if not patched.exists():
        return "[ERROR] Missing patched task_intents_patched.json file."
